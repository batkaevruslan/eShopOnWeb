...
CREATE USER "eShopWeb2StagingSlot" FROM EXTERNAL PROVIDER;
ALTER ROLE db_datareader ADD MEMBER "eShopWeb2StagingSlot";
ALTER ROLE db_datawriter ADD MEMBER "eShopWeb2StagingSlot";
ALTER ROLE db_ddladmin ADD MEMBER "eShopWeb2StagingSlot";